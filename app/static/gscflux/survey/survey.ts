...
class SurveyController extends ModelController {
	constructor(private $scope, private surveys: SurveyService) {
	    super(surveys);
...
.directive('gscSurvey', createFluxDirective({
	templateUrl: 'gscflux/survey/survey.html',
	controller: SurveyController
}))

.directive('gscSurveyLocation', createFluxDirective({
...
.directive('gscSurveySubjects', createFluxDirective({
